  ...
  return (
    <div className="shadow-md w-full left-0 top-0">
      <div className="md:flex items-center justify-between py-4 md:px-10 px-7">
        ...
        <div>
          <ul
            className={`md:flex md:items-center md:pb-0 pb-12 absolute md:static  bg-blue-100 lg:bg-transparent md:bg-transparent md:z-auto z-[-1] left-0 w-full md-w-auto md:pl-0 pl-9 transition-all duration-500 ease-in ${
              open
                ? "top-14 opacity-100"
